...
The package uses the [targets](https://books.ropensci.org/targets/) package to ensure reproducibility. In order to rerun the analyses, clone the repository, open the R project within it, and run the following in R:
